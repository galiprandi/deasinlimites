...
/**
 * Validates that a path component does not contain traversal sequences
 * or directory separators to prevent Path Traversal attacks.
 */
function validatePath(part: string): void {
