...
- **Arquitectura CSS Compartida**: Centralizar estilos de componentes estructurales (ej. Hero) en `styles/shared.module.css` para garantizar paridad visual absoluta y facilitar el mantenimiento evolutivo.
