...
- **Unificación de Héroe**: Todas las páginas informativas (Acerca de, Papers, Categorías) deben compartir el diseño de cabecera neutro (`var(--bd-grey)`) para mantener una cohesión de marca sólida.
