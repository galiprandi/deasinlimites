...
- **Unificación de Héroe**: Todas las páginas informativas (Acerca de, Papers, Categorías) deben compartir el diseño de cabecera neutro (`var(--bd-grey)`) e incluir acentos de color en los títulos (`h1 span`) para mantener una cohesión de marca sólida.
