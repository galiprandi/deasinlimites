...
- **Advanced Search Usability**: Refined search interactions with `Escape` key support for clearing and blurring, automatic focus return on manual clear, and `aria-keyshortcuts` for improved accessibility.
