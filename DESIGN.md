...
- **Micro-UX de Búsqueda**: Mejora del feedback visual en el campo de búsqueda con sombras multi-capa y un diseño de estado vacío ("No results") más estructurado y elegante. Implementación del manejo de la tecla `Escape` para limpiar y desenfocar el campo, junto con el retorno automático del foco al usar el botón de limpieza manual.
