...
## 2026-06-17 - [Estimated Reading Time & Icon Accessibility]
**Learning:** Estimated reading time provides immediate value to users by setting expectations for content length. Decorative icons associated with such metadata must be explicitly hidden from screen readers to maintain a clean acoustic experience.
**Action:** Integrated reading time calculation into the markdown pipeline and displayed it with accessible decorative icons in 'PostCard' and article headers.
