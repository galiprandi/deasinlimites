...
## 2025-05-16 - [Visual Scroll Feedback]
**Learning:** For long-form content, providing a non-intrusive visual indicator of reading progress (like a top progress bar) reduces cognitive load. Throttling scroll listeners with `requestAnimationFrame` ensures smooth performance.
**Action:** Implement `ReadingProgressBar` on all detail views where vertical scrolling is primary.
