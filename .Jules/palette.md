...
## 2025-05-15 - [Visual Scroll Depth Feedback]
**Learning:** For long-form content, a reading progress bar provides non-intrusive feedback that helps users gauge their progress and reduces bounce rates by setting expectations.
**Action:** Use `requestAnimationFrame` to throttle scroll listeners for high-frequency UI updates like progress bars to maintain 60fps performance.
